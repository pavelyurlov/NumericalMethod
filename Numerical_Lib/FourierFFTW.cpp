...
Distribution1D Fourier::Convolution(Distribution1D a, Distribution1D b)
{
	...
	for (uint i = 0; i < a.GetSize(); i++) // выход за пределы, если массивы разного размера. Ќо этого не должно случитьс€.
	{
	...
	Distribution1D res = a; // TODO: проверить копирование. Ћучше сделать через пр€мое создание
